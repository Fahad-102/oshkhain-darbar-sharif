            ...
            <main className="max-w-4xl mx-auto bg-white p-8 md:p-12 shadow-lg rounded-lg border-t-8 border-green-700">
                ...
                <section className="mb-8">
                    <p className="text-gray-700 leading-relaxed text-lg">
                        চট্টগ্রামের ঐতিহ্যবাহী আনোয়ারা থানার অন্তর্গত ০৯নং পরৈকোড়া ইউনিয়নে ওষখাইন নামক গ্রামে আধ্যাত্মিক সাধক হযরত শাহ আলী রজা (রহ:) শায়িত আছেন। তাঁর মাতা প্রদত্ত নাম 'আলী রজা' এবং পীরের দেওয়া মহব্বতের নাম 'কানু শাহ্'। তিনি ইসলামের প্রথম খলিফা হযরত আবু বক্কর ছিদ্দীক (রা:) এবং হযরত ইমাম হোসাইন (রা:) এর বংশধর।
                    </p>
                </section>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-10">
                    <div className="bg-green-50 p-6 rounded-md">
                        <h2 className="font-bold text-green-800 border-b border-green-200 pb-2 mb-3">জন্ম ও পরিচয়</h2>
                        <ul className="space-y-2 text-sm">
                            <li><strong>জন্ম:</strong> ১৭৫৯ ইংরেজি, ১৭ ই শ্রাবণ ১১৬৫ বাংলা, ১০ রবিউস সানি ১১৫৯ হিজরি (সোমবার, সোবহ্‌ সাদেকের সময়)।</li>
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        তিনি আরবি, ফার্সী, বাংলা, সংস্কৃতসহ ৩৬টি ভাষায় পারদর্শী ছিলেন। তাঁর রচিত জ্ঞান সাগর গ্রন্থটি আমেরিকার সিকাগো ও সুইডেনের স্টকহোম ইউনিভার্সিটি থেকে "The Ocean of Love" নামে প্রকাশিত ও পাঠ্যভুক্ত হয়েছে। তিনি এক হাজারের অধিক দাওয়াত এবং সাত শতাধিক মারফতি গজল রচনা করেছেন।
                    </p>
                ...
                <footer className="mt-10 pt-6 border-t border-gray-200 text-center text-gray-500 italic">
                    আল্লাহ তাআলার এই মহান ওলী তাঁর আধ্যাত্মিক সাধনা ও সাহিত্য কর্মের মাধ্যমে চিরস্মরণীয় হয়ে আছেন।
                </footer>
            </main>
        </div>
    );
