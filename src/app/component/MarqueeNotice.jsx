...
const MarqueeNotice = () => {
  ...
  return (
    <div className="bg-green-600/95 text-white py-3 border-y border-green-700/50 flex overflow-hidden select-none font-tiro relative z-10">
      ...
      <div className="relative w-full flex items-center overflow-hidden">
        <motion.div
          className="flex whitespace-nowrap text-sm md:text-base pl-6 gap-20"
